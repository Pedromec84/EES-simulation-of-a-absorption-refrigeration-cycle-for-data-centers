# EES-simulation-of-a-absorption-refrigeration-cycle-for-data-centers
# Copiar e colar o código abaixo no software EES
"Thermo-economic analysis of steady state waste heat recovery in data centers using absorption refrigeration Khosrow Ebrahimi, Gerard F. Jones, Amy S. Fleischer"
"Considerando"
T_amb = 25[C]
...
"PAPER (Ebrahimi, 2015): Point 1. Knowing the temperatures at condenser and evaporator, the corresponding pressures are calculated through the use of the following empirical equation developed by Sun [16]."
p_COND = exp(9,48654 + (3892,7/(42,6776 - T_c)))*convert(MPa;kPa)
p_EVAP = exp(9,48654 + (3892,7/(42,6776 - T_e)))*convert(MPa;kPa)
 
"PAPER (Ebrahimi, 2015): Point 2. Knowing the temperatures at absorber, evaporator, generator, and condenser the concentration of LiBr in the strong and weak solutions is calculated using equations presented in Lansing [17]."
...
"PAPER (Ebrahimi, 2015): Point 3. Knowing the pressure and temperature of water at the outlet of generator (state 7), condenser (state 8) and evaporator (state 10), the enthalpy is calculated through the REFPROP subroutine. In this case, was used the EES routine"
"PAPER (Ebrahimi, 2015): Point 4. h[8] = h[9]"
"PAPER (Ebrahimi, 2015): Point 5. Knowing the pressure and enthalpy of water, the temperature at the outlet of valve (state point 9) can be found through REFPROP. In this study, was used the EES routine"
"PAPER (Ebrahimi, 2015): Point 6.Knowing the solution temperature and concentration, the enthalpy of solution at the outlet of the absorber (state 1) and generator (state 4) through the standard formulations developed by Kaita [19]."
...
"PAPER (Ebrahimi, 2015): Point 12. Knowing the solution mass flow rates (from step 8) and the heat capacities of the weak and strong solution streams (from step 11), the heat capacity rates of weak and solution streams are calculated"
"C = m_dot*cp"
C_2 = m_dot_[2]*cp_2
C_4 = m_dot_[4]*cp_4
C_1 = m_dot_[1]*cp_1
